...
//                       <input type="text" maxLength={4} onChange={(e) => setOtp(e.target.value)} value={otp} name='otp' placeholder='****' className='py-3 px-4 w-full border border-gray-300 text-center tracking-[0.8rem] text-xl mb-4 rounded focus:outline-none focus:border-blue-500'/>
//               </div>
//               <button className='w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded'>Submit</button>

//               <p className='text-sm text-gray-600 mt-4'>Didn't receive the OTP? <span className='text-blue-500'>Resend OTP</span>  in {count} seconds</p>
        ...
        {!showNumber ? (
          ...
          <div className=" flex justify-start bg-white rounded-xl items-center w-[40%] py-10 px-10">
            <div className="bg-white rounded w-full">
              ...
              <button onClick={() => setIsOtpVerified(true)} className="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                Submit
              </button>
