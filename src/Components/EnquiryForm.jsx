        ...
        { !isSent ? (
          ...
          <div className='flex-[7] p-8 md:px-12 flex flex-col gap-6 '>
            <div>
              ...
              <h1 className='text-2xl font-semibold'><FiCheckCircle className='text-green-500 inline w-8 h-8 mr-2' /> Submitted</h1>
              <FiX className='w-5 h-5 cursor-pointer' onClick={() => {
                                onClose()

                setIsSent(false)
              }} />
              </div>
              <p className='text-gray-600 text-sm md:text-base mt-2'>We have received your enquiry, we will get back to you shortly</p>
              <p className='text-gray-600 text-sm md:text-base mt-2'>Thank you!</p>
            </div>
