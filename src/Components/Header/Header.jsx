...
import { FiDollarSign, FiLogOut, FiMapPin, FiMenu, FiUser, FiX } from "react-icons/fi";
  ...
  return (
    ...
    <div className={`${homePage && 'text-white shadow-none'} text-black shadow-md relative flex justify-between items-center px-4 py-4 md:hidden`}>
        ...
        <div className="flex gap-6 items-center">
             ...
             <div className="flex text-sm items-center gap-2 cursor-pointer" onClick={() => setMobileProfileOpen(!mobileProfileOpen)}>
           <img
             src={
                  user.image ||
                  "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png"
        ...
        <div className="flex justify-end" onClick={() => setMenuOpen(false)}>
        ...
        <div className="flex justify-end" onClick={() => setMobileProfileOpen(false)}>
            <FiX className="w-5 h-5" />
        </div>
