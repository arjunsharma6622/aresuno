...
import OInputField from './reusable/OInputFields';
  ...
  const handlePasswordClick = async (e) => {
    ...
    try {
      const res = await axios.patch(
        ...
        { password: updatedPassword?.newPassword, phone: phoneNumber },
      );
      setUpdatedPassword({
        newPassword: "",
        confirmPassword: "",
            ...
            <div className="px-3 py-3 w-full md:w-full bg-white md:p-6 md:py-10 rounded-xl">
              ...
              <div className="">
                <form className={`flex flex-col gap-4 mt-6`}>
                  ...
                  <button
                    type="submit"
                    className={`bg-blue-500 rounded-lg px-3 text-sm md:text-base py-2 md:py-3 md:px-5 text-white ${!updatedPassword?.confirmPassword ||
                      updatedPassword?.newPassword !==
                      updatedPassword?.confirmPassword
                      ? "cursor-not-allowed"
                      : ""
