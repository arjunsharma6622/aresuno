                                ...
                                <tr key={index}>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="flex gap-2 items-center">
                                            <img
                                                src={ratingReview.user.profileImg || "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png"}
                                                alt=""
...
const VendorDashboard = () => {
    ...
    const handlePasswordClick = async (e) => {
        ...
        try {
            const res = await axios.patch("https://aresuno-server.vercel.app/api/vendor/", { password: updatedPassword.newPassword }, {
                headers: {
                            ...
                            <div className="">
                                ...
                                {selectedField === "profile" && (
                                    <div className="w-full flex justify-center items-center flex-col gap-10">
                                        <img src="https://picsum.photos/200" alt="" className="rounded-full w-28 h-28" />
                                            ...
                                            <div className="w-1/2">
                                                ...
                                                <div className="">
                                                    <form className={`flex flex-col gap-4 mt-6`}>
                                                        ...
                                                        {updatedPassword.confirmPassword && (updatedPassword.newPassword !== updatedPassword.confirmPassword ? (
