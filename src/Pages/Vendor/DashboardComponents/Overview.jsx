...
<div className="flex justify-between gap-6">
        ...
        <div className="flex-[7] w-full  rounded">
        ...
        <h2 className="mb-4 text-base font-semibold">Recent Posts</h2>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex justify-center gap-4 h-28">
              <div className="">
                <img src="https://images.unsplash.com/photo-1599566150163-29194dcaad36?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="" className="w-24 h-full aspect-auto object-cover rounded-lg"/>
              </div>
              <div className="flex-[8] flex flex-col justify-between">
                <span className="text-base font-semibold">Aresuno</span>
                <p className="text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, porro eligendi. Doloremque id modi enim velit tempora atque, architecto perferendis?</p>
