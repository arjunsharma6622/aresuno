...
const ServiceCard = ({ business }) => {
  ...
  return (
    <div
      className="flex md:flex-row flex-col border rounded-lg relative overflow-hidden"
      key={business._id}
    >
      <script
      ...
      <div className="flex-[3.5] relative">
        ...
        >
          <img
            ...
            alt=""
            className="w-full h-44 md:h-52 object-cover rounded-tl-lg rounded-bl-lg"
          />
        </Link>
      </div>
      ...
      <div className="bg-white flex-[8.5] py-2 md:flex-[8] w-full rounded-tr-lg rounded-br-lg flex flex-col justify-between gap-6 md:gap-4">
        <div className="flex px-4 flex-col gap-2">
          ...
          <div className="flex items-end gap-4 justify-between">
            ...
            <div className="flex gap-3 flex-col justify-start items-end">


              <button
                className="w-full h-fit px-2 py-2 md:px- md:py-2 bg-blue-500 text-white rounded-lg"
              ...
              <button
                ...
                className="w-full h-fit text-sm  md:px-4 px-3 py-2  md:py-2 text-white bg-blue-500 flex items-center justify-center gap-3 rounded-lg"
              >
