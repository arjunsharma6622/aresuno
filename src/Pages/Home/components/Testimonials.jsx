...
const Testimonials = () => {
  return (
    <div className="text-center">
      ...
      <div className="text-neutral-500 text-center text-base leading-6 self-center mt-4 max-md:max-w-full">
      ...
      <div className="self-center w-[80%] mx-auto mt-14 px-5 max-md:max-w-full max-md:mt-10">
