                ...
                <table className="w-full text-sm table-auto">
                    <thead className="">
                        <tr className="bg-gray-300">
                            ...
                            <th className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Business</th>
                            <th className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Owned</th>
                            ...
                            <th className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Edit</th>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {businesses.map((business, index) => (
                            <tr key={index}>
                                ...
                                <td className="px-2 py-4 whitespace-nowrap">{business.vendorName}</td>
                                <td className="px-2 py-4 whitespace-nowrap">{new Date( business.createdAt).toLocaleDateString("en-US", { year: 'numeric', month: 'short', day: 'numeric' })}</td>
                                <td className="px-2 py-4 whitespace-nowrap">{business.category.name}</td>
